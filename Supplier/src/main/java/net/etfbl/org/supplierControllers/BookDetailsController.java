...
public class BookDetailsController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		 ...
		 Platform.runLater(() -> {
			 ...
			 taBookContent.setText(book.getBookContent());
	 ...
	 private Image convertBase64ToImage(String base64) {
		 ...
		 try{
			...
			// TODO: handle exception
			 SupplierLogger.LOGGER.log(Level.SEVERE, "An error occured in the method convertBase64ToImage.", e);
	 ...
	 private Image getDefaultImage() {
		 return new Image(getClass().getResourceAsStream(PropertiesFileLoader.getInstance().getSpeciefiedProperty("default_image")));
	 }
